...
import com.omh.android.storage.api.drive.nongms.data.util.toByteArrayOutputStream
...
internal class NonGmsFileRemoteDataSourceImpl(private val retrofitImpl: GoogleRetrofitImpl) :
    ...
    private fun downloadDocs(fileId: String, mimeType: String): ByteArrayOutputStream {
        val response = retrofitImpl
            .getGoogleStorageApiService()
            .downloadDocFile(fileId = fileId, mimeType = mimeType)
            .execute()
